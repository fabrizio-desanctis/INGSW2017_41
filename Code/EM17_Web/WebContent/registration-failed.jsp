        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Registrazione fallita!</h2>
                    <p>Siamo spiacenti, l'indirizzo e-mail è stato già utilizzato.</p>
                    <a href="login.jsp">Clicca qui per essere trasferito alla schermata di login</a><br>
                    <a href="registration.jsp">Clicca qui per riprovare la registrazione</a></div>
