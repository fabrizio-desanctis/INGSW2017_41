        ...
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <form method="POST" action="AddUser"><label><strong>DATI ANAGRAFICI</strong></label>
                    <div class="form-group"><label for="name">Nome</label><input pattern="[a-zA-Z'\s]{2,30}" autofocus required title="Sono ammessi solo caratteri alfabetici." placeholder="Inserire il nome." class="form-control item" type="text" inputmode="latin-name" name="nome"></div>
                    <div class="form-group"><label for="name">Cognome</label><input pattern="[a-zA-Z'\s]{2,30}" required title="Sono ammessi solo caratteri alfabetici." placeholder="Inserire il cognome." class="form-control item" type="text" inputmode="latin-name" name="cognome"></div>
                    <div class="form-group"><label for="name">Telefono/Cellulare</label><input  minlength="10" maxlength="10" pattern="\d*" required title="Sono ammessi solo numeri (0-9). Il numero deve essere composto da 10 cifre." placeholder="Inserire recapito telefonico." class="form-control item" type="text" inputmode="tel" name="telefono"></div>
                    <div class="form-group"><label for="name">Sesso</label><select  name="sesso" class="form-control" style="width:82px;"><option value="1" selected="">M</option><option value="2">F</option></select></div>
                    ...
                    <div class="form-group"><label for="name">Città</label><input pattern="[a-zA-Z'\s]{2,30}" required title="Sono ammessi solo caratteri alfabetici." placeholder="Inserire una città." class="form-control item" type="text" inputmode="latin-name" id="citta" name="citta"></div>
                    <div class="form-group"><label for="name">Provincia</label><input minlength="2" maxlength="2" pattern="[a-zA-Z'\s]{2,2}" required title="Sono ammessi solo caratteri alfabetici." placeholder="Inserire la provincia." class="form-control item" type="text" inputmode="latin-name" id="provincia" name="provincia"></div>
                    <div class="form-group"><label for="name">CAP</label><input name="cap" minlength="5" maxlength="5" pattern="\d*" required title="Sono ammessi solo caratteri numerici." placeholder="Inserire il CAP." class="form-control item" type="text" inputmode="numeric" id="cap" name="cap"></div><label><strong>DATI DI ACCESSO</strong></label>
