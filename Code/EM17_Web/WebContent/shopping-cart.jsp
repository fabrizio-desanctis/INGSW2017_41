...
<body>
 ...
 <li class="nav-item" role="presentation"><a class="nav-link" href="SearchEvent2?param=Concerti">CONCERTI</a></li>
                ...
                <ul class="nav navbar-nav ml-auto">
                    ...
                    <li class="nav-item" role="presentation"><a class="nav-link active" href="shopping-cart.html">CARRELLO(0) &nbsp;<i class="fa fa-shopping-cart"></i></a></li>
                </ul>
        </div>
        </div>
    </nav>
                    ...
                    <div class="row no-gutters">
                                ...
                                <div class="product">
                                    <div class="row justify-content-center align-items-center">
                                        ...
                                        <div class="col-md-5 product-info">
                                            <h3><strong><% out.print(e.getNome()); %></strong></h3><label><strong>Prezzo</strong>:&nbsp;</label><span id="prezzo"><% out.print(e.getPrezzo()); %></span><span> EUR</span>
                                            <div class="row">
                                                <div class="col"><label><strong>Quantità</strong>:&nbsp;</label><span id="quantita"><% out.print(e.getNumeroBiglietti()); %></span></div>
                                            </div>
                                            <div class="row">
                                              <div class="col"><a href="shopping-cart.html">Rimuovi</a></div>
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-12 col-lg-4">
                            ...
                            <% float totale = e.getPrezzo()*e.getNumeroBiglietti();%>
                                <h3>RIEPILOGO</h3>
                                <h4><span class="text">Subtotal</span><span class="price"><%out.print(totale); %> EUR</span></h4>
                                <h4><span class="text">Altri costi</span><span class="price">0 EUR</span></h4>
                                <h4><span class="text">Totale</span><span id="total" class="price"><strong id="total"><% out.print(totale); %> EUR</strong></span></h4>
                                <br>
